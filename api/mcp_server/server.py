...
_SERVER_INSTRUCTIONS = (
    ...
    "wait for teacher direction, then use only selected exact course_id/assignment_id "
    "rows. "
    ...
    "private full scoring refresh. If it returns mirror_refresh_in_progress, wait "
    ...
    "or assignment type. Read every SAFE page with get_scoring_packet, including its "
    "contract and rubric; held work and evidence gaps are not empty. Submit only that "
    "packet's pseudonym/item results with expected_packet_digest through "
    "submit_scoring_results once. Canvas applies gradebook or late-policy adjustments; "
