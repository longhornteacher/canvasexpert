...
RETIRED_PATHS = (
    ...
    ("api/webui/routes/gradebook.py", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
    ("api/webui/routes/gradebook_common.py", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
    ("api/webui/routes/gradebook_policy.py", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
    ("api/webui/routes/gradebook_extra_time.py", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
    ("api/webui/routes/gradebook_snapshot.py", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
    ("api/webui/templates/gradebook.html", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
    ("api/webui/static/gradebook.js", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
    ("api/webui/static/gradebook", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
    ("api/webui/static/pages/gradebook.css", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
    ("api/tests/test_gradebook_routes.py", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
    ("api/tests/test_gradebook_policy_routes.py", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
    ("api/tests/webui/routes/test_gradebook_extra_time.py", "(none)", "Retire the unlinked Gradebook console page; grading lives in Canvas Live and MCP"),
